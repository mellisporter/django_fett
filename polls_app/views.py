...
from django.template import loader # lpoads templates 


from .models import Choice, Question # imports questions from question list
...
#     ## updated with render shortcut. loads correctly. 

# def detail(request, question_id):
#     question = get_object_or_404(Question, pk=question_id) ## renders error if no object
#     return render(request, 'polls_app/detail.html', {'question': question}) # renders detail view
